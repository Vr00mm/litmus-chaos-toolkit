...
import (
	...
	litmusLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/kubelet-service-kill/lib"
	clients "github.com/Vr00mm/litmus-chaos-toolkit/pkg/clients"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/events"
	experimentEnv "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/kubelet-service-kill/environment"
	experimentTypes "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/kubelet-service-kill/types"
...
func KubeletServiceKill(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of kubelet-service-kill experiment (SOT), err: " + err.Error()
