...
import (
	...
	litmusLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/pod-cpu-hog-exec/lib"
	clients "github.com/Vr00mm/litmus-chaos-toolkit/pkg/clients"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/events"
	experimentEnv "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/pod-cpu-hog-exec/environment"
	experimentTypes "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/pod-cpu-hog-exec/types"
...
func PodCPUHogExec(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of pod-cpu-hog-exec experiment (SOT), err: " + err.Error()
