...
import (
	...
	litmusLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/network-chaos/lib/loss"
	pumbaLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/pumba/network-chaos/lib/loss"
...
func PodNetworkLoss(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of pod-network-loss experiment (SOT), err: " + err.Error()
