...
import (
	...
	litmusLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/pod-network-partition/lib"
	clients "github.com/Vr00mm/litmus-chaos-toolkit/pkg/clients"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/events"
	experimentEnv "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/pod-network-partition/environment"
...
func PodNetworkPartition(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of pod-network-partition experiment (SOT), err: " + err.Error()
