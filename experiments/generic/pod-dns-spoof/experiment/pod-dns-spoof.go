...
import (
	...
	litmusLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/pod-dns-chaos/lib"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/clients"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/events"
	experimentEnv "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/pod-dns-chaos/environment"
	experimentTypes "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/pod-dns-chaos/types"
...
func PodDNSSpoof(clients clients.ClientSets) {
	...
	if err = result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of pod-dns-spoof experiment (SOT), err: " + err.Error()
