...
import (
	...
	litmusLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/stress-chaos/lib"
	pumbaLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/pumba/pod-io-stress/lib"
	clients "github.com/Vr00mm/litmus-chaos-toolkit/pkg/clients"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/events"
	experimentEnv "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/stress-chaos/environment"
	experimentTypes "github.com/Vr00mm/litmus-chaos-toolkit/pkg/generic/stress-chaos/types"
...
func PodIOStress(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of " + experimentsDetails.ExperimentName + " experiment (SOT), err: " + err.Error()
