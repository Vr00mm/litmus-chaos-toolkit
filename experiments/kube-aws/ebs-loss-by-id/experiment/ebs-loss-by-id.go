...
import (
	...
	litmusLIB "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/ebs-loss/lib/ebs-loss-by-id/lib"
	clients "github.com/Vr00mm/litmus-chaos-toolkit/pkg/clients"
	aws "github.com/Vr00mm/litmus-chaos-toolkit/pkg/cloud/aws/ebs"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/events"
	experimentEnv "github.com/Vr00mm/litmus-chaos-toolkit/pkg/kube-aws/ebs-loss/environment"
...
func EBSLossByID(clients clients.ClientSets) {
	...
	if err = aws.EBSStateCheckByID(experimentsDetails.EBSVolumeID, experimentsDetails.Region); err != nil {
		...
		failStep := "[post-chaos]: Failed to verify if the ebs volume is attached to an ec2 instance, err: " + err.Error()
		result.RecordAfterFailure(&chaosDetails, &resultDetails, failStep, clients, &eventsDetails)
		return
	}
