...
import (
	...
	kafkaPodDelete "github.com/Vr00mm/litmus-chaos-toolkit/chaoslib/litmus/kafka-broker-pod-failure/lib"
	clients "github.com/Vr00mm/litmus-chaos-toolkit/pkg/clients"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/events"
	"github.com/Vr00mm/litmus-chaos-toolkit/pkg/kafka"
	experimentEnv "github.com/Vr00mm/litmus-chaos-toolkit/pkg/kafka/environment"
...
func KafkaBrokerPodFailure(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of kafka-broker-pod-failure experiment (SOT), err: " + err.Error()
	...
	case "litmus":
		if err := kafkaPodDelete.PreparePodDelete(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
			...
			failStep := "[chaos]: Failed in chaos injection phase, err: " + err.Error()
			result.RecordAfterFailure(&chaosDetails, &resultDetails, failStep, clients, &eventsDetails)
			return
		}
	default:
